...
parameters.grid_size = 4630;  % grid size of mesh deformation
...
% Images to stitch.
%-----------------------
tar = 1; ref_n = 2;  % choose the target and reference image
pathname = strcat('capture_3\precut_imgs\'); %
