close all; clear all;
run('D:\000\Drops\Stitch_Methods\Robust_Elastic_Warping\vlfeat-0.9.14\toolbox\vl_setup');
addpath('transforms');
...
exp_path = 'images/REW_worktable';
imfile1 = [exp_path '/' 'worktable_01.JPG'];
imfile2 = [exp_path '/' 'worktable_02.JPG'];
